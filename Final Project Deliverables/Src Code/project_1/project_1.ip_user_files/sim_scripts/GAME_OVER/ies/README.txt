...
#
# Generated by export_simulation on Tue Jun 07 11:51:29 -0700 2016
#
################################################################################
...
switch to the './GAME_OVER.sh' script.

./GAME_OVER.sh -reset_run
...
./GAME_OVER.sh -noclean_files

For more information on the script, please type './GAME_OVER.sh -help'.
