...
#
# Generated by export_simulation on Tue Jun 07 16:29:05 -0700 2016
#
################################################################################
...
switch to the './GAME_WIN.sh' script.

./GAME_WIN.sh -reset_run
...
./GAME_WIN.sh -noclean_files

For more information on the script, please type './GAME_WIN.sh -help'.
