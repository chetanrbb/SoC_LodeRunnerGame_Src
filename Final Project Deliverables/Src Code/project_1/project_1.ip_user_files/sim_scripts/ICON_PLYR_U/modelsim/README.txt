...
#
# Generated by export_simulation on Fri Jun 03 21:19:52 -0700 2016
#
################################################################################
...
switch to the './ICON_PLYR_U.sh' script.

./ICON_PLYR_U.sh -reset_run
...
./ICON_PLYR_U.sh -noclean_files

For more information on the script, please type './ICON_PLYR_U.sh -help'.
