...
# executing this script. Please type 'Opnt1_Icon_R.sh -help' for more information.
#
...
reset_run()
{
  files_to_remove=(ucli.key Opnt1_Icon_R_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc Opnt1_Icon_R_simv.daidir)
...
compile()
{
  ...
  vlogan -work xil_defaultlib $opts_ver +v2k \
    "$ref_dir/../../../../project_1.srcs/sources_1/ip/Opnt1_Icon_R/Opnt1_Icon_R_sim_netlist.v" \
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.Opnt1_Icon_R xil_defaultlib.glbl -o Opnt1_Icon_R_simv
}
...
simulate()
{
  ...
  ./Opnt1_Icon_R_simv $opts -do simulate.do
}
# Script usage
usage()
{
