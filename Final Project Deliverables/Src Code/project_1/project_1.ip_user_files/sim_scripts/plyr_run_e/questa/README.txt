...
#
# Generated by export_simulation on Tue Jun 07 19:32:47 -0700 2016
#
################################################################################
...
switch to the './plyr_run_e.sh' script.

./plyr_run_e.sh -reset_run
...
./plyr_run_e.sh -noclean_files

For more information on the script, please type './plyr_run_e.sh -help'.
