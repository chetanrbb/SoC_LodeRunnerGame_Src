...
#
# Generated by export_simulation on Tue Jun 07 17:50:38 -0700 2016
#
################################################################################
...
switch to the './snd_hp.sh' script.
...
./snd_hp.sh -noclean_files

For more information on the script, please type './snd_hp.sh -help'.
