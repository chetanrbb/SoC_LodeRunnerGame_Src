...
#
# Generated by export_simulation on Sat Jun 04 21:04:20 -0700 2016
#
################################################################################
...
switch to the './world_map_ram.sh' script.

./world_map_ram.sh -reset_run
...
./world_map_ram.sh -noclean_files

For more information on the script, please type './world_map_ram.sh -help'.
