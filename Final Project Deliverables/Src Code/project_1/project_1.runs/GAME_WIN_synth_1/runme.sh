...
HD_PWD='E:/System_on_Chip/Projects/Final/Project 2/project_1/project_1.runs/GAME_WIN_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GAME_WIN.vds -m64 -mode batch -messageDb vivado.pb -notrace -source GAME_WIN.tcl
