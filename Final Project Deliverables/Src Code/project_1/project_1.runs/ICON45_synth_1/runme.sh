...
HD_PWD='E:/System_on_Chip/Projects/Project 2/project_1/project_1.runs/ICON45_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ICON45.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ICON45.tcl
