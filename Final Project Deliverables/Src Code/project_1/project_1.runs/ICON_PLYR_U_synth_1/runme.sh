...
HD_PWD='E:/System_on_Chip/Projects/Final/Project 2/project_1/project_1.runs/ICON_PLYR_U_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ICON_PLYR_U.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ICON_PLYR_U.tcl
