...
HD_PWD='E:/System_on_Chip/Projects/Final/Project 2/project_1/project_1.runs/MAIN_SCRN_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MAIN_SCRN.vds -m64 -mode batch -messageDb vivado.pb -notrace -source MAIN_SCRN.tcl
