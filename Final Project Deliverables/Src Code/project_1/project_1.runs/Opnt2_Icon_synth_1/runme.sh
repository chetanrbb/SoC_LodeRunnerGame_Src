...
HD_PWD='E:/System_on_Chip/Projects/Final/Project 2/project_1/project_1.runs/Opnt2_Icon_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Opnt2_Icon.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Opnt2_Icon.tcl
