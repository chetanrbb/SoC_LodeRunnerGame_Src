...
HD_PWD='E:/System_on_Chip/Projects/Final/Project 2/project_1/project_1.runs/Opnt_Icon1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Opnt_Icon1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Opnt_Icon1.tcl
