...
HD_PWD='E:/System_on_Chip/Projects/Final/Project 2/project_1/project_1.runs/World_map_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log World_map.vds -m64 -mode batch -messageDb vivado.pb -notrace -source World_map.tcl
