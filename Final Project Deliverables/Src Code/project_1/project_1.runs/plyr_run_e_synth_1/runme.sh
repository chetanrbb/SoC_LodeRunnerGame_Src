...
HD_PWD='E:/System_on_Chip/Projects/Final/Project 2/project_1/project_1.runs/plyr_run_e_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log plyr_run_e.vds -m64 -mode batch -messageDb vivado.pb -notrace -source plyr_run_e.tcl
