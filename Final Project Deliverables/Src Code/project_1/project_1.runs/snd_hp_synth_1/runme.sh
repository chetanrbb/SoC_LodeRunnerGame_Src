...
HD_PWD='E:/System_on_Chip/Projects/Final/Project 2/project_1/project_1.runs/snd_hp_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log snd_hp.vds -m64 -mode batch -messageDb vivado.pb -notrace -source snd_hp.tcl
