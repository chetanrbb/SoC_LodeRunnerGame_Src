...
HD_PWD='E:/System_on_Chip/Projects/Final/Project 2/project_1/project_1.runs/world_map_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log world_map_ram.vds -m64 -mode batch -messageDb vivado.pb -notrace -source world_map_ram.tcl
