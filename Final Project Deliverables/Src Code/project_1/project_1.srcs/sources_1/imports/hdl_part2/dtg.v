...
// we have to start the  hsync pulse after the visible area + front porch 
// the hsync pulse duration must be in the duration of sync pulse duration ~96


parameter
		HORIZ_PIXELS = 512,  HCNT_MAX  = 799, HCNT_END = 699, 		
		HSYNC_START  = 659,  HSYNC_END = 755,         // add front porch with sync pulse
//         HSYNC_START = visible_area + front_porch+3  
		VERT_PIXELS  = 480,  VCNT_MAX  = 524,
		VSYNC_START  = 493,  VSYNC_END = 494;
	
//parameter 
//        HORIZ_PIXELS = 512, HCNT_MAX = (1328-1), HCNT_END = 1199,
//        HSYNC_START = (1048+3), HSYNC_END = (1048+136+3),
        
//        VERT_PIXELS = 480, VCNT_MAX = 805,  // vcnt_max = visible_area+frnt_prch+bck_prch
//        VSYNC_START = (771+3), VSYNC_END = (777-1+3); // vsync_strt = vrt_pxl+frnt_prch 
                                            // vsync_end = vrt_pxl+frnt_prch+bck_prch
